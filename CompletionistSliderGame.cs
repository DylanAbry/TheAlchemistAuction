...
public class CompletionistSliderGame : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((PlayerPrefs.GetInt("NormalSliderComplete", 0) == 1) && (PlayerPrefs.GetInt("ExpertSliderComplete", 0) == 1) && (PlayerPrefs.GetInt("EpicGamerSliderComplete", 0) == 1))
        {
            PlayerPrefs.SetInt("SliderModesComplete", 1);
            PlayerPrefs.Save();
        }
    }
